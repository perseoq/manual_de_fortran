...
description: >
  ...
  Genera archivos .md con pre-explicación conceptual, código comentado, análisis
  línea por línea, salida esperada, errores típicos y mini-proyectos.
---

# Skill: Crear manual técnico pedagógico

Esta skill permite generar manuales técnicos completos siguiendo el patrón
pedagógico utilizado en los manuales de este repositorio (index.md, manual_axum.md,
manual_rocket.md, manual_devops.md, manual_selenium.md, manual_testing_*.md,
manual_tauri_yew.md).
